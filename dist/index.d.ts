...
export declare const DENOTA_APIURL_REMOTE_MUMBAI =
  "https://klymr.me/graph-mumbai";
...
export declare function tokenAddressForCurrency(
  currency: string
): string | undefined;
export declare function approveToken({
  currency,
  approvalAmount,
}: ApproveTokenProps): Promise<void>;
...
export declare function write({
  module,
  ...props
}: WriteProps): Promise<string>;
interface FundProps {
  cheqId: string;
}
export declare function fund({
  cheqId,
}: FundProps): Promise<string | undefined>;
interface CashPaymentProps {
  cheqId: string;
  type: "reversal" | "release";
}
export declare function cash({
  cheqId,
  type,
}: CashPaymentProps): Promise<string | undefined>;
...
export declare function getNotasQueryURL():
  | "https://denota.klymr.me/graph/mumbai"
  | "https://denota.klymr.me/graph/alfajores"
  | undefined;
