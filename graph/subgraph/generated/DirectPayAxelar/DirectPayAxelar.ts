...
export class DirectPayAxelar__dappOperatorFeesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class DirectPayAxelar__payInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: string;
  value3: string;
...
export class DirectPayAxelar__processCashInputParam5Struct extends ethereum.Tuple {
  get escrowed(): BigInt {
    return this[0].toBigInt();
  }
...
export class DirectPayAxelar__processFundInputParam5Struct extends ethereum.Tuple {
  get escrowed(): BigInt {
    return this[0].toBigInt();
  }
...
export class DirectPayAxelar extends ethereum.SmartContract {
  static bind(address: Address): DirectPayAxelar {
    return new DirectPayAxelar("DirectPayAxelar", address);
  }
  ...
  dappOperatorFees(param0: Address): DirectPayAxelar__dappOperatorFeesResult {
    ...
    return new DirectPayAxelar__dappOperatorFeesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_dappOperatorFees(
    param0: Address
  ): ethereum.CallResult<DirectPayAxelar__dappOperatorFeesResult> {
    ...
    return ethereum.CallResult.fromValue(
      new DirectPayAxelar__dappOperatorFeesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  getFees(dappOperator: Address): DirectPayAxelar__getFeesResultValue0Struct {
    let result = super.call(
      "getFees",
    ...
    return changetype<DirectPayAxelar__getFeesResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getFees(
  ...
  ): ethereum.CallResult<DirectPayAxelar__getFeesResultValue0Struct> {
    let result = super.tryCall(
      "getFees",
      "getFees(address):((uint256,uint256,uint256,uint256))",
      [ethereum.Value.fromAddress(dappOperator)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<DirectPayAxelar__getFeesResultValue0Struct>(value[0].toTuple())
    );
  }

  payInfo(param0: BigInt): DirectPayAxelar__payInfoResult {
    let result = super.call(
      "payInfo",
      "payInfo(uint256):(uint256,uint256,string,string,address)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    );

    return new DirectPayAxelar__payInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toString(),
      result[3].toString(),
  ...
  try_payInfo(
    param0: BigInt
  ): ethereum.CallResult<DirectPayAxelar__payInfoResult> {
    let result = super.tryCall(
      "payInfo",
      "payInfo(uint256):(uint256,uint256,string,string,address)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new DirectPayAxelar__payInfoResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toString(),
        value[3].toString(),
  ...
  processCash(
    ...
    param3: BigInt,
    param4: BigInt,
    param5: DirectPayAxelar__processCashInputParam5Struct,
    param6: Bytes
  ): BigInt {
    let result = super.call(
      "processCash",
      "processCash(address,address,address,uint256,uint256,(uint256,uint256,address,address),bytes):(uint256)",
      [
        ethereum.Value.fromAddress(param0),
  ...
  processFund(
    ...
    param3: BigInt,
    param4: BigInt,
    param5: DirectPayAxelar__processFundInputParam5Struct,
    param6: Bytes
  ): BigInt {
    let result = super.call(
      "processFund",
      "processFund(address,address,uint256,uint256,uint256,(uint256,uint256,address,address),bytes):(uint256)",
      [
        ethereum.Value.fromAddress(param0),
        ethereum.Value.fromAddress(param1),
