...
function writeDirectPay(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var dueDate, type, creditor, debitor, utcOffset, dueTimestamp, d, today, owner, receiver, amountWei, payload, tokenAddress, msgValue, tx, receipt;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    dueDate = module.dueDate, type = module.type, creditor = module.creditor, debitor = module.debitor;
