...
exports.cashReversibleRelease =
  exports.fundReversibleRelease =
  exports.writeReversibleRelease =
    void 0;
      ...
      switch (_d.label) {
        case 0:
          (imageUrl = module.imageUrl),
            ...
            (debitor = module.debitor),
            (inspector = module.inspector);
          notaInspector =
            inspector !== null && inspector !== void 0 ? inspector : debitor;
          amountWei = ethers_1.ethers.utils.parseEther(String(amount));
          owner = creditor;
          receiver = type === "invoice" ? debitor : creditor;
          payload = ethers_1.ethers.utils.defaultAbiCoder.encode(
            ...
            [
              ...
              imageUrl !== null && imageUrl !== void 0 ? imageUrl : "",
            ]
          );
          tokenAddress =
            (_b = (0, __1.tokenAddressForCurrency)(currency)) !== null &&
            _b !== void 0
              ? _b
              : "";
          msgValue =
          ...
          return [
            4 /*yield*/,
            (_c = __1.state.blockchainState.registrar) === null || _c === void 0
              ? void 0
              : _c.write(
    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            (_b = __1.state.blockchainState.registrar) === null || _b === void 0
              ? void 0
              : _b.fund(
                  notaId,
                  amount, // escrow
      ...
      switch (_c.label) {
        case 0:
          ...
          return [
            ...
            (_b = __1.state.blockchainState.registrar) === null || _b === void 0
              ? void 0
              : _b.cash(notaId, amount, to, payload),
          ];
        case 1:
          tx = _c.sent();
          return [4 /*yield*/, tx.wait()];
