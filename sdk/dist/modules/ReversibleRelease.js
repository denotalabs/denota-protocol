...
function writeReversibleRelease(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var type, creditor, debitor, inspector, notaInspector, amountWei, owner, receiver, payload, tokenAddress, msgValue, tx, receipt;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    type = module.type, creditor = module.creditor, debitor = module.debitor, inspector = module.inspector;
