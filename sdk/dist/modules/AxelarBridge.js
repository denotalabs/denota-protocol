    ...
    return __generator(this, function (_d) {
      switch (_d.label) {
        case 0:
          ...
          api = new axelarjs_sdk_1.AxelarQueryAPI({
            environment: axelarjs_sdk_1.Environment.TESTNET,
          });
          return [
            4 /*yield*/,
            api.estimateGasFee(
              axelarjs_sdk_1.CHAINS.TESTNET["CELO"],
              axelarjs_sdk_1.CHAINS.TESTNET["POLYGON"],
              "CELO",
              300000, // gas limit
              1.2 // gas multiplier
            ),
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            (_c = __1.state.blockchainState.axelarBridgeSender) === null ||
            _c === void 0
              ? void 0
              : _c.createRemoteNota(
                  ...
                  chainInfo_1.ContractAddressMapping.mumbai.bridgeReceiver,
                  { value: msgValue }
                ),
          ];
        case 2:
