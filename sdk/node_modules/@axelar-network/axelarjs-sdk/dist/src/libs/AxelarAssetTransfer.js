...
class AxelarAssetTransfer {
    ...
    getOfflineDepositAddressForERC20Transfer(fromChain, toChain, destinationAddress, fromChainModule = "evm", tokenSymbol, refundAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            yield (0, utils_2.throwIfInvalidChainIds)([fromChain, toChain], this.environment);
            yield this.axelarQueryApi.throwIfInactiveChains([fromChain, toChain]);
            const _refundAddress = refundAddress ||
    ...
    getDepositAddressFromRemote(type, fromChain, toChain, destinationAddress, refundAddress, hexSalt, tokenSymbol = undefined) {
        return __awaiter(this, void 0, void 0, function* () {
