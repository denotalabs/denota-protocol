...
class AxelarQueryAPI {
     ...
     */
    getNativeGasBaseFee(sourceChainId, destinationChainId, sourceTokenSymbol, symbol, amount, destinationContractAddress, sourceContractAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            yield (0, utils_2.throwIfInvalidChainIds)([sourceChainId, destinationChainId], this.environment);
            ...
            return this.axelarGMPServiceApi
                .post("", params)
                .then((response) => {
                const { base_fee, source_token, destination_native_token, express_fee, express_supported } = response.result;
                ...
                const expressFee = express_fee
                    ? (0, utils_1.parseUnits)(express_fee.toString(), decimals).toString()
                    : "0";
                return {
                    baseFee,
                    expressFee,
    ...
    estimateGasFee(sourceChainId, destinationChainId, sourceChainTokenSymbol, gasLimit = contract_1.DEFAULT_ESTIMATED_GAS, gasMultiplier = 1.1, minGasPrice = "0", gmpParams) {
        return __awaiter(this, void 0, void 0, function* () {
            yield (0, utils_2.throwIfInvalidChainIds)([sourceChainId, destinationChainId], this.environment);
            const response = yield this.getNativeGasBaseFee(sourceChainId, destinationChainId, sourceChainTokenSymbol, gmpParams === null || gmpParams === void 0 ? void 0 : gmpParams.tokenSymbol, gmpParams === null || gmpParams === void 0 ? void 0 : gmpParams.transferAmount, gmpParams === null || gmpParams === void 0 ? void 0 : gmpParams.destinationContractAddress, gmpParams === null || gmpParams === void 0 ? void 0 : gmpParams.sourceContractAddress).catch(() => undefined);
            if (!response)
                return "0";
            ...
            if (!success || !baseFee || !sourceToken)
                return "0";
            const destGasPrice = (0, utils_1.parseEther)(destToken.gas_price);
            let srcGasPrice = (0, utils_1.parseEther)(sourceToken.gas_price);
