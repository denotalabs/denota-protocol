...
export declare class AxelarQueryAPI {
    ...
    getConfirmationHeight(chain: string): Promise<import("@axelar-network/axelarjs-types/axelar/evm/v1beta1/query").ConfirmationHeightResponse>;
    /**
     ...
     */
    getNativeGasBaseFee(sourceChainId: EvmChain | string, destinationChainId: EvmChain | string, sourceTokenSymbol?: GasToken, symbol?: string, amount?: number, destinationContractAddress?: string, sourceContractAddress?: string): Promise<BaseFeeResponse>;
    /**
     ...
     * @returns
     */
    estimateGasFee(sourceChainId: EvmChain | string, destinationChainId: EvmChain | string, sourceChainTokenSymbol: GasToken | string, gasLimit?: number, gasMultiplier?: number, minGasPrice?: string, gmpParams?: GMPParams): Promise<string | AxelarQueryAPIFeeResponse>;
    /**
