...
//                 Strings.toString(invoice.startTime),
//                 "},",
//                 '{"trait_type":"Current Milestone","value":',
//                 Strings.toString(invoice.currentMilestone),
//                 "},",
//                 '{"trait_type":"Total Milestones","value":',
//                 Strings.toString(invoice.totalMilestones),
//                 "},",
//                 '{"trait_type":"Client","value":"',
//                 Strings.toHexString(uint256(uint160(invoice.client))),
//                 '"},',
//                 '{"trait_type":"Worker","value":"',
//                 Strings.toHexString(uint256(uint160(invoice.worker))),
//                 '"},',
//                 '{"trait_type":"DocumentHash","value":"',
//                 string(abi.encodePacked(invoice.documentHash)),
//                 '"},',
//                 '{"trait_type":"Revoked","value":',
//                 invoice.isRevoked ? "true" : "false",
//                 "}"
//             )
//         );
...
//         (bytes32 docHash, uint256[] memory milestoneAmounts) = abi.decode(
//             initData,
//             (bytes32, uint256[])
//         );
...
//         require(
//             escrowed == milestoneAmounts[0],
//             "Escrowed must be first milestone"
//         );
...
//                 escrowed ==
//                     payments[notaId]
//                         .milestones[payments[notaId].currentMilestone]
//                         .amount,
//                 "Escrowed must be current milestone"
//             );
...
//             if (
//                 payments[notaId].currentMilestone >
//                 payments[notaId].totalMilestones
//             ) revert("Already_Funded_Last_Milestone"); // All milestones funded (allow last one to be claimed)
//             require(
//                 escrowed ==
//                     payments[notaId]
//                         .milestones[payments[notaId].currentMilestone]
...
//                 revert NotCashableYet();
//             if (payments[notaId].milestones[cashingMilestone].isCashed)
...
//             abi.encodePacked(
//                 ',{"trait_type":"Current Milestone","value":',
//                 Strings.toString(payment.currentMilestone),
//                 "},",
//                 '{"trait_type":"Total Milestones","value":',
//                 Strings.toString(payment.totalMilestones),
//                 "},",
//                 '{"trait_type":"Payer","value":"',
//                 Strings.toHexString(uint256(uint160(payment.payer))),
//                 '"},',
//                 '{"trait_type":"DocumentHash","value":"',
//                 string(abi.encodePacked(payment.documentHash)),
//                 '"},',
//                 '{"trait_type":"Revoked","value":',
//                 payment.isRevoked ? "true" : "false",
//                 "}"
//             )
//         );
